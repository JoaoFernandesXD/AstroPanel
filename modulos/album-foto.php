    ...
    $foto = $_FILES['imagem'];
            if(!empty($foto["name"])){
              ...
              if(count($error) == 0) {
                ...
                mysqli_query($conexao, "INSERT INTO fotos_album (imagem, data, galeria_id) VALUES ('$nome_imagem','$data','$id')");
                header("Location: ?link=postar-foto-album&id=$id"); 
            }else{
...
?>
   <form method="post" enctype="multipart/form-data">
    ...
    <div id="conteudo">Seleciona As fotos Para inserir
    <br> 
    		<form method="post" enctype="multipart/form-data">
                  <br> 
            ...
            <input type="file" name="imagem[]" multiple="multiple"/><br><br>
				...
				<input name="submit"  type="submit" id="submit_padrao" value="Postar Fotos" />
			</form>
	</div>
