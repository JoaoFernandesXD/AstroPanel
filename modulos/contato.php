...
var apagar = {
 ...
 <div id="barra_celulas">
		<div id="m_c_a"></div>
		<div id="m_c_t" style="margin-left: -50px;">E-mail</div>
		<div id="m_c_s">Assunto/Mensagem</div>
	...
	?>
		<div id="dados_celula">
			...
			<div id="titulo_celula" style="margin-left: 10px;"><?php echo Encurta($ver['email'],999); ?><br /><font style="color: #838383; font-size: 12px;"><?php echo Encurta($ver['texto'],40); ?></font></div>
			<div id="data_celula" style="margin-right: 280px;"><?php echo Encurta($ver['mensagem'],20); ?><br /></div>
