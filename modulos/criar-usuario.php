...
<?php
  ...
  $foto = $_FILES['imagem'];
        ...
        if(count($error) == 0) {
          ...
          echo "<script>alert('Usuário criado!');</script>";
          mysqli_query($conexao, "INSERT INTO gc_usuario (usuario, senha, ultimo_ip, ultimo_acesso, status, email, cargo, membro, imagem) VALUES ('$usuario','$senha','1','1','ativo','$email','$cargo','$data','$nome_imagem')");
        ...
        echo "<script>alert('Usuário criado');</script>";
          mysqli_query($conexao, "INSERT INTO gc_usuario (usuario, senha, ultimo_ip, ultimo_acesso, status, email, cargo, membro, imagem) VALUES ('$usuario','$senha','1','1','ativo','$email','$cargo','$data','padrao.png')");
        //header('Location: ?link=equipe'); 
