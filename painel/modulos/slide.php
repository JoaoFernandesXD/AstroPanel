...
<script src="https://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
  ...
  <div id="bx_inicio">Categorias</div>
  <a href="index.php?link=postar-slide"><div id="pag-inicial">Criar categoria</div></a>
  <br>
  <br>
  <div id="barra_celulas">
        <div id="m_c_a">Imagem</div>
        <div id="m_c_t">Titulo categoria</div>
...
<style type="text/css">
    ...
    $sql = mysqli_query($conexao, "SELECT * FROM categorias ORDER BY id_ordem ASC");
    while($ver = mysqli_fetch_array($sql)){
    ?>  <div id ="<?php echo $ver['cad_ordem_item']; ?>">
        <div id="dados_celula">
            <div id="id_foto" style="background-image: url(uplouds/<?php echo $ver['imagem']; ?>);"></div>
            <div id="titulo_celula"><?php echo $ver['id_ordem']; ?> - <?php echo Encurta($ver['nome'],40); ?><br /><font style="color: #838383; font-size: 12px;"></font></div>
    ...
    $(function(){
            ...
            $(".sortable").sortable({
                ...
                update: function(event, ui) {
                     ...
                     $.ajax({
                         url: '/painel/modulos/cad_ordenar_item.php',
                         type: 'POST',
